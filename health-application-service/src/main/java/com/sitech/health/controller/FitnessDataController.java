...
import com.sitech.dbs.health_service.api.service.v2.FitnessDataApi;
...
@Slf4j
@RestController
public class FitnessDataController implements FitnessDataApi {
    ...
    @Override
    public ResponseEntity<HealthData> postFitness(FitnessData fitnessData) {
        UserContextDto userContextLite = userContextService.getUserContextLite();
       return fitnessService.postFitness(userContextLite,languageUtil.getRequestedLanguage(httpServletRequest) ,fitnessData);
    }
}
