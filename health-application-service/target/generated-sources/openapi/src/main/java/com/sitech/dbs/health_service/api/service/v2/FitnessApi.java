...
@Api(value = "Fitness", description = "the Fitness API")
public interface FitnessApi {

    /**
     * POST /client-api/v1/fitness
     ...
     */
    @ApiOperation(value = "", nickname = "postFitness", notes = "Adds or updates a redeem", response = FitnessData.class, tags={ "fitness", })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/client-api/v1/fitness",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    ResponseEntity<FitnessData> postFitness(
            @ApiParam(value = ""  )
            @Valid
